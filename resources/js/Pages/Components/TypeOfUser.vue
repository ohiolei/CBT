        ...
        <div class="bg-gray-200 bg-opacity-25 grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 p-6 lg:p-8">
            <div>
                ...
                <p class="mt-4 text-sm">
                    <button @click.prevent="createStudent()" class="inline-flex items-center font-semibold text-indigo-700">
                        Registration
            ...
            <div>
                ...
                <p class="mt-4 text-sm">
                    <button @click.prevent="createLecturer()" class="inline-flex items-center font-semibold text-indigo-700">
                        Registration
...
export default {
    ...
    methods: {
        createStudent(){
            axios.post('user_manager/create_student').then().catch(err => console.error(err.response.data))
        },
        createLecturer(){
            axios.post('user_manager/create_lecturer').then().catch(err => console.error(err.response.data))
        }
    },
    mounted(){
