              ...
              <div class="flex flex-col">
                <div class="-m-1.5 overflow-x-auto">
                  <div class="p-1.5 min-w-full inline-block align-middle">
                    <div class="overflow-hidden">
                      <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <caption class="py-2 text-start text-sm text-gray-600 dark:text-gray-500">Your registered
                          courses
                        </caption>
                        <thead>
                          <tr>
...
export default {
  ...
  methods: {
    ...
    fetchCourse() {
      axios.get('/student/get_student_course').then((res) => {
    ...
    updateCourse() {
      ...
      axios.put('/student/update_student_course', {
        courses: course_json
      }).then(res => {
