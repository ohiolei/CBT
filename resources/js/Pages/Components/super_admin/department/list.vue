    ...
    <div>
        <table class="w-full">
            ...
            <tbody class="bg-white">
                <tr class="text-gray-700" v-for="(department, index) in departments" :key="index">
                    ...
                    <td class="px-4 py-3 text-ms font-semibold border">{{ department.college.college_code }}</td>
                    <td class="px-4 py-3 text-xs border">
                        {{ department.campus }}
                    </td>
                    <td class="px-4 py-3 text-center text-sm border">
                        <div class="relative inline-block text-left">
                            <button @click="toggleDropdown(department.id)"
                            ...
                            <div v-if="openDropdown === department.id"
